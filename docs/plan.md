...
- Добавить модель данных для строк (source_site, category_url, product_url, discovered_at, run_id, status, note, расширения) и правила идемпотентности (проверка существования URL во вкладке, md5-хэш).
